...
{
    public partial class frmAddSpot : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                using (SqlCommand cmd = new SqlCommand("INSERT INTO spot VALUES (@n)", con))
                {
        ...
        private void frmAddSpot_Load(object sender, EventArgs e)
        {
            LoadGrid();
        }
        ...
        private void dataGridView1_SelectionChanged(object sender, EventArgs e)
        {
            if (this.dataGridView1.SelectedRows.Count > 0)
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM spot where spotId = @id", con);
        ...
        {
            con.Open();
            using (SqlCommand cmd = new SqlCommand("UPDATE spot SET spotName=@n WHERE spotId=@i", con))
            {
        ...
        {
            con.Open();
            using (SqlCommand cmd = new SqlCommand("DELETE FROM spot WHERE spotId=@i", con))
            {
